...
class QwirkleEnv(gym.Env):
    ...
    def legal_actions(self):
        logger.debug("Now inside legal_actions")
        ...
        if self.flag_is_board_empty:
            ...
            logger.debug(f"Inside the board empty if statemtent and here is the first_move_legal_actions")
            logger.debug(first_move_legal_actions)
            
            return first_move_legal_actions

        logger.debug(f"The flag_is_board_empty is {self.flag_is_board_empty}, the if statement has passed")
        ...
        while True:
            ...
            # logger.debug(f"legal_actions: {legal_actions}")
